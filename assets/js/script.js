...
const ticketMasterApiKey = "NKLwGZ8Q2Ia64tUfDRcaU1AUZ0ChUWGW"
    ...
    function renderResults() {
        ...
        resultsContainerEl.innerHTML = '';
         ...
         googleBtn.setAttribute('class', 'button mb-5 is-info is-light is-hovered');
    ...
    function handleGoogleButtonClick(event) {
        ...
        const query = `${eventType} events in ${eventCity}`;
    ...
    function handleMoreInfoButtonClick(event, eventObj) {
        ...
        // Event Link - Will only be displayed if eventObj.link is not empty //
        if(eventObj.link) {
